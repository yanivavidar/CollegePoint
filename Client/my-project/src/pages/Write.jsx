      ...
      <div className="w-[85%] mx-auto">
        ...
        <div className="writeForm w-full relative flex flex-col flex-wrap items-center ">
          <div className="writeFormGroup w-full flex flex-col">
            <div className="flex flex-row items-center p-4 text-xl gap-[10px]">
              ...
              <div className="writeFormGroup ss:block hidden ">
                <button className="writeSubmit bg-blue-600 text-white px-5 pt-[0.6rem] pb-[0.75rem] rounded-[30px]">
                  Publish
                </button>
              </div>
            </div>
            <TextareaAutosize
              className="pr-[1rem] pl-[4rem] pb-[1rem]"
          ...
          <div className="writeFormGroup">
            <button className="writeSubmit mt-[18%] block ss:hidden bg-blue-600 text-white px-5 pt-[0.6rem] pb-[0.75rem] mb-3 rounded-[30px]">
              Publish
            </button>
          </div>
        </div>
