          ...
          <form action="" className="settingsForm flex flex-col">
            ...
            <div className="flex">
              <div className="flex-[50%]">
                <label htmlFor="" className="text-[20px] mt-5 mr-2">
                  First name
                </label>
                <br />
                <input
                  ...
                  className="profileInput hover:border-gray"
                  style={borderStyle}
            ...
            <div className="flex">
              <div className="flex-[50%]">
                <label htmlFor="" className="text-[20px] mt-5">
                  Username
                </label>
                <br />
                <input
            ...
            <button
              className="bg-yellow-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded settingsSubmit"
              style={{
                marginTop: "50px",
                width: "100px",
              }}
