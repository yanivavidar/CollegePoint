  ...
  return (
    <div className="flex flex-col justify-center items-center w-[90%] m-auto">
      <div className="py-5">
        ...
        <img
          src="https://avatars.githubusercontent.com/u/139516615?v=4"
          alt="pfp"
        />
        ...
        <p className="single-post-desc">
          ...
          Voluptatibus, excepturi aspernatur. Ex, quaerat libero corrupti esse
          at reiciendis tempore dolorum, autem maiores velit quae eaque
          aspernatur, voluptatem porro itaque voluptates. Minima cupiditate
          itaque voluptatibus inventore perferendis laudantium consectetur
          expedita, amet possimus?
        </p>
      </div>
    </div>
  );
